...
function taggedPictures({tags, excludeTags = []}) {
...
export async function getHighlightedPicture({tags, excludeTags}) {
  const pictures = await getAllPictures()
  const highlightedPicture = pictures.find(taggedPictures({tags, excludeTags}))
