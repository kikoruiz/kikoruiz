...
export default function ButtonToggle({
  ...
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className={`flex appearance-none items-center border border-neutral-700 px-3 py-1.5 text-xs font-light shadow-xs first-of-type:rounded-l-full last-of-type:-ml-px last-of-type:rounded-r-full hover:z-0 ${
        isToggled
