...
export default function PictureInfo({
  ...
  return (
    isOpen && (
      <dl className="relative inline-grid auto-rows-max grid-cols-2 py-4 text-xs font-extralight text-neutral-300/60 after:absolute after:left-0 after:top-0 after:block after:h-px after:w-full after:bg-linear-to-r after:from-transparent after:via-orange-300/30 sm:grid-cols-4 sm:text-sm sm:font-thin">
