...
const resumeHeadingStyles = cva(
  'flex flex-col gap-3 text-neutral-900/60 font-light text-sm',
  {
    variants: {
      position: {
        center: 'items-center lg:flex-row lg:justify-center lg:gap-9',
        right: 'absolute right-12 top-28 lg:top-24 lg:right-24'
      }
    }
  }
)
